        ...
        <div className="w-100">
          ...
          <section id="about" className="pageAbout jumptarget">
            ...
            <div className="w-800p margin-center container-fluid">
              ...
              <p className="speech">
                Version Alpha is Dallas’s first gaming-focused hackathon hosted in the middle of <a className="branding-orange" href="https://dreamhack.com/dallas/"><b>DreamHack Dallas</b></a>, a three-day event with everything gaming under one roof. <a className="branding-orange" href="https://weareasterisk.com/"><b>Asterisk</b></a> is proud to partner with DreamHack to bring together the best elements of hackathons and gaming in a high powered weekend full of building, prototyping, and epic gg’s.
                <br/>
                <br/>
